...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2022 at 12:21 PM
...
--
-- Database: `db_akademik_0500`
--

-- --------------------------------------------------------

--
-- Table structure for table `tbl_students_0500`
--

CREATE TABLE `tbl_students_0500` (
  `id` int(15) NOT NULL,
...
--
-- Dumping data for table `tbl_students_0500`
--

INSERT INTO `tbl_students_0500` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0500`
--
ALTER TABLE `tbl_students_0500`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0500`
--
ALTER TABLE `tbl_students_0500`
